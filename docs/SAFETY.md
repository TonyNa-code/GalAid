...
- Preflight ZIP/RAR/7z/self-extracting EXE package metadata, supported disc-image directory metadata, and disc-image media roles in the desktop beta before any extraction or mounting
