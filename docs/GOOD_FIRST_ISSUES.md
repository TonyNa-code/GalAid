...
- Keep package preflight wording clear that preflight reads directory/media metadata only, while any extraction or mounting requires an explicit desktop action.
