...
<table>
  <tr>
    <td width="25%" valign="top"><strong>01 Drop</strong><br>Folders, `.zip/.rar/.7z/.lzh`, self-extracting `.exe` packages, split archives, `.iso`, `.cue/.bin`, `.mds/.mdf`, and older VN layouts all enter one flow.</td>
