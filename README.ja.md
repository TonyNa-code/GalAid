...
- デスクトップ版では、古い DirectX、VC++ 再頒布可能パッケージ、RPG Maker RTP、システム locale を確認し、PC 側の不足を切り分けられる
