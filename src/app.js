...
const ASSISTANT_LANGUAGE_PACKS = {
  "zh-CN": {
    ...
    ui: {
      ...
      runtimeAssistantBody: "检测这台 Windows 电脑上的 DirectX、VC++、.NET、VB6、QuickTime/旧视频组件、RPG Maker RTP 和系统区域。",
  ...
  en: {
    ...
    ui: {
      ...
      runtimeAssistantBody: "Checks this Windows PC for legacy DirectX files, VC++ redistributables, .NET, VB6, QuickTime/video components, RPG Maker RTP, and locale state.",
  ...
  ja: {
    ...
    ui: {
      ...
      runtimeAssistantBody: "この Windows PC の古い DirectX、VC++、.NET、VB6、QuickTime/動画コンポーネント、RPG Maker RTP、locale 状態を確認します。",
